...
const ShopPage = () => {
  ...
  // В реальном приложении его нужно получать из авторизации или другого источника.
  const userTelegramId = "467518658"; // или "7241281378"
  ...
  // Пример обработчика поиска (если понадобится)
      ...
      <div className="container">
        <div className="shop-inner">
          ...
          <div className="shop-block">
            ...
            {/* Отображаем блок поиска и фильтра только для указанных telegram id */}
            {["467518658", "7241281378"].includes(userTelegramId) && (
              <div className="shop-block__nav f-center-jcsb">
                <div className="shop-block__search">
                  ...
                  <input
                    type="search"
                    name="search"
                    // searchTerm можно добавить в состояние и использовать здесь
                    // value={searchTerm}
