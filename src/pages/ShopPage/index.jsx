...
const ShopPage = () => {
  // Пример: текущий telegram id пользователя.
  // В реальном приложении его нужно получать из авторизации, контекста или localStorage.
  const userTelegramId = "467518658"; // или "7241281378" или другой id
  ...
  // Состояния для фильтрации по цене и типу
  ...
  // Функция фильтрации по цене и типу
  const handleFilter = () => {
      ...
      <div className="container">
        <div className="shop-inner">
          ...
          <div className="shop-block">
            ...
            {
              // Если id пользователя равен одному из двух, показываем блок поиска и фильтра.
              // Иначе – отображаем блок "Скоро".
              userTelegramId === "467518658" ||
              userTelegramId === "7241281378" ? (
                <div className="shop-block__nav f-center-jcsb">
                  <div className="shop-block__search">
                    ...
                    <input
                      type="search"
                      name="search"
                      // Здесь можно добавить searchTerm и handleSearch при необходимости
                      required
                    />
                  </div>
                  <div
                    ...
                    <li key={item.id} className="shop-list__item">
                      <div className="shop-list__card">
                        ...
                        >
                          <img
                            src={
                              ["set", "energy", "money"].includes(item.id)
                                ? item.image
                                : item.image
                            }
                            alt=""
